...
const senderData = [
  ...
  { name: 'Bank', value: 'Bank of Australia' },
...
const receiverData = [
  ...
  { name: 'Receiving Type', value: 'Payment Wallet' },
  { name: 'Wallet ID', value: '98457895665' },
  { name: 'Amount', value: '40,000.00' },
...
export default function SendModal({ isOpen, closeModal }: OrderSummaryProps) {
              ...
              <div className="relative">
                ...
                <Dialog.Panel className="w-full max-w-[930px] transform overflow-hidden rounded-[10px] bg-white px-12 py-10 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="flex justify-end gap-8">
                    ...
                    <Button onClick={()=>{
                        closeModal;
                        router.push('/remittance/send-money-verify')
                    }} className="w-44 py-5">
                      Send now
                    </Button>
                  </div>
